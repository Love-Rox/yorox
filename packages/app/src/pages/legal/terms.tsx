    ...
    <article className="max-w-[70ch]">
      ...
      <section className="mt-6">
        ...
        <p className="mt-2 text-sm leading-relaxed">
          ...
          <strong>取引は利用者と主催者の間で成立</strong>します。運営者は決済の場を
          提供するのみで、取引の当事者にはなりません。返金の実施可否は主催者が判断します。
        </p>
      </section>

      <section className="mt-6">
        <h2 className="display border-b-2 border-ink pb-2 t-md">第4条(禁止事項)</h2>
      ...
      <section className="mt-6">
        <h2 className="display border-b-2 border-ink pb-2 t-md">第5条(免責)</h2>
        <p className="mt-2 text-sm leading-relaxed">
          運営者は、本サービスの内容や利用者間・主催者との取引について、
          法令で許容される範囲で一切の責任を負いません。
        </p>
      </section>

      <section className="mt-6">
        <h2 className="display border-b-2 border-ink pb-2 t-md">第6条(規約の変更)</h2>
        <p className="mt-2 text-sm leading-relaxed">
